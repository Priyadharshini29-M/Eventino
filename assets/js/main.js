...
$(document).ready(function(){
  $(".testimonials-slider").owlCarousel({
    ...
    margin: 10,              /* Adds margin between the cards */
    nav: true,               /* Adds navigation arrows */
    dots: false,             /* Removes dots if you don't want them */
    autoplay: true,          /* Enables auto sliding */
    autoplayTimeout: 3000,   /* Sets the autoplay speed */
    responsive: {
      0: {
        items: 1             /* 1 card at a time in mobile view */
      },
      600: {
        items: 2             /* 2 cards in tablet view */
      },
      1000: {
        items: 3             /* 3 cards in desktop view */
      }
    }
  });
});
